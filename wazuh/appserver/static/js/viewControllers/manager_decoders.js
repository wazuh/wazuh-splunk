  ...
  function (
    ...
    $(document).ready(function () {
      service.request(
        ...
        table.build(baseUrl + '/custom/wazuh/manager/decoders?ip=' + parsedData[0].url + '&port=' + parsedData[0].portapi + '&user=' + parsedData[0].userapi + '&pass=' + parsedData[0].passapi, opts)
        table.click(data => {
