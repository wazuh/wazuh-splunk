...
def setup_logger(level):
    ...
    file_handler = logging.handlers.RotatingFileHandler(make_splunkhome_path(['var', 'log', 'splunk', 'manager_controller.log']), maxBytes=25000000, backupCount=5)
...
class manager(controllers.BaseController):
    ...
    def info(self, **kwargs):
        ...
        myJson = json.dumps(manager_info)
        return myJson
