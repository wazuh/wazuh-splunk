define(['../module'], function (module) {
  ...
  module.config([ '$stateProvider','BASE_URL', function ($stateProvider,BASE_URL) {
    ...
    // settings -> about
    .state('settings.about', { templateUrl: BASE_URL + '/static/app/SplunkAppForWazuh/js/controllers/settings/about/about.html', onEnter: ($navigationService) => { $navigationService.storeRoute('settings.about') } })
    // settings -> api
    .state('settings.api', {
