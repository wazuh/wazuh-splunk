/*
 * Wazuh app - Wazuh Register Agent
...
define(['../module', '../../libs/codemirror-conv/lib/codemirror'], function (
        ...
        controller(
            ...
            $scope.addAgent = async () => {
                try {
                    ...
                    const data = await $requestService.apiReq('/agents', {
                    ...
                    $scope.addingAgent = false;
                    $notificationService.showErrorToast('Adding agent error: ' + error);
                }
                return;
            }
            ...
            $scope.restartAgent = async () => {
                ...
                try {
                    ...
                    $notificationService.showSimpleToast(`Success. Agent ${$scope.registerObj.systems[$scope.registerObj.selectedSystem].steps[0].agentName} has been registered.`);
                    $scope.nextStep();
    ...
    app.directive('wzRegisterAgent', BASE_URL => new wzRegisterAgent(BASE_URL))
