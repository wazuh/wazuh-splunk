define(['../../module', '../../../utils/config-handler'], function (
  ...
  class ConfigurationController {
    ...
    $onInit() {
      try {
        this.scope.nodes = (((this.clusterInfo.nodes || []).data || []).data || []).total_affected_items || []
        ...
        this.scope.canReadCluster = this.clusterInfo.clusterEnabled && this.scope.nodes.length > 0
      } catch (error) {
