  ...
  class AgentsGeneral extends DashboardMain {
    ...
    constructor(
      ...
      this.vizz = [
        ...
        new SearchHandler(
          `searchLevel12`,
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} "rule.level">=12 | chart count`,
          `level12token`,
          '$result.count$',
          'levelTwelve',
          this.submittedTokenModel,
        ...
        new SearchHandler(
          `searchAuthFailure`,
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} "rule.groups{}"="authentication_fail*" | stats count`,
          `authFailureToken`,
          '$result.count$',
          'authFailure',
          this.submittedTokenModel,
        ...
        new SearchHandler(
          `searchAuthSuccess`,
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType}  "rule.groups{}"="authentication_success" | stats count`,
          `authSuccessToken`,
          '$result.count$',
          'authSuccess',
          this.submittedTokenModel,
        ...
        new PieChart(
          'top5AlertsVizz',
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} | top "rule.description" limit=5`,
          'top5AlertsVizz',
          this.scope
        ),
        new PieChart(
          'top5GroupsVizz',
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} | top rule.groups{} limit=5`,
          'top5GroupsVizz',
          this.scope
        ),
        new PieChart(
          'top5PCIreqVizz',
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} | top rule.pci_dss{} limit=5`,
          'top5PCIreqVizz',
          this.scope
        ),
        new LinearChart(
          'alertGroupEvoVizz',
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} rule.level=*| timechart count by rule.groups{}  `,
          'alertGroupEvoVizz',
          this.scope,
        ...
        new Table(
          'groupsSummaryVizz',
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} | stats count by rule.groups{} | sort count DESC  | rename rule.groups{} as "Group", count as Count`,
          'groupsSummaryVizz',
          this.scope
        ),
