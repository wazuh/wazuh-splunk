  ...
  class AgentsNist extends DashboardMain {
    ...
    constructor(
      ...
      this.dropdown = new Dropdown(
        'dropDownInput',
        `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} rule.nist_800_53{}="*"| stats count by "rule.nist_800_53{}" | sort "rule.nist_800_53{}" ASC | fields - count`,
        'rule.nist_800_53{}',
        '$form.nist$',
        'dropDownInput',
        this.scope
      ...
      this.vizz = [
        ...
        new SingleValue(
          'maxRuleLevel',
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} rule.nist_800_53{}="$nist$" | top rule.level | sort - rule.level`,
          'maxRuleLevel',
          this.scope
        ),
        new SingleValue(
          'totalAlerts',
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} rule.nist_800_53{}="$nist$" | stats count`,
          'totalAlerts',
          this.scope
        ),
        new PieChart(
        ...
        new BarChart(
          ...
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} rule.nist_800_53{}="$nist$" | chart count(rule.nist_800_53{}) by rule.level,rule.nist_800_53{} | rename count as "Count" , rule.level as "Level", rule.nist_800_53{} as "Requirement"`,
          'requirementsDistributedByLevel',
          this.scope,
          { stackMode: 'stacked' }
        ),
        new ColumnChart(
          ...
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} rule.nist_800_53{}="$nist$" | timechart count by rule.nist_800_53{} | rename count as "Count", rule.nist_800_53{} as "Requirement"`,
          'requirementsOverTime',
          this.scope,
          { stackMode: 'stacked' }
        ),
