  ...
  TimePicker
    ...
    class MainCtrl{
      constructor($scope, $urlTokenModel){
        ...
        this.layoutView = new LayoutView({ 'hideFooter': false, 'hideSplunkBar': false, 'hideAppBar': true, 'hideChrome': false })
        .render()
        .getContainerElement()
      ...
      $onInit(){
        ...
        this.dashboardController.onReady( () => {
          if (!this.urlTokenModel.has('earliest') && !this.urlTokenModel.has('latest')) {
