  ...
  class Osquery extends DashboardMain {
    ...
    constructor(
      ...
      this.vizz = [
        ...
        new AreaChart(
          'alertsPacksOverTime',
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} | timechart span=1h count by data.osquery.pack`,
          'alertsPacksOverTime',
          this.scope,
        ...
        new PieChart(
          'topOsqueryAdded',
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} data.osquery.action="added"  | top data.osquery.name limit=5`,
          'topOsqueryAdded',
          this.scope
        ),
        new PieChart(
          'topOsqueryRemoved',
          `${this.filters} sourcetype=${this.currentDataService.getSourceType().sourceType} data.osquery.action="removed"  | top data.osquery.name limit=5`,
          'topOsqueryRemoved',
          this.scope
        ),
        new PieChart(
