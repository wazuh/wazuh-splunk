define([
  ...
  UrlTokenModel) {
    ...
    controllers.controller('overviewVulnerabilitiesCtrl', function ($scope, $currentApiIndexService) {
      const vm = this
      ...
      criticalSeveritySearch = new SearchManager({
        ...
        "status_buckets": 0,
        "search": "index=" + selectedIndex + " " + nameFilter + " sourcetype=wazuh rule.alertsSeverityOverTime=\"audit\" rule.id=80790 | stats count",
      ...
      highSeveritySeach = new SearchManager({
        ...
        "earliest_time": "$when.earliest$",
        "status_buckets": 0,
        "search": "index=" + selectedIndex + " " + nameFilter + " sourcetype=wazuh rule.alertsSeverityOverTime=\"audit\" rule.id=80784 | stats count",
        "latest_time": "$when.latest$",
        "app": utils.getCurrentApp(),
        "auto_cancel": 90,
        "preview": true,
      ...
      mediumSeveritySearch = new SearchManager({
        ...
        "earliest_time": "$when.earliest$",
        "status_buckets": 0,
        "search": "index=" + selectedIndex + " " + nameFilter + " sourcetype=wazuh rule.alertsSeverityOverTime=\"audit\" rule.id=80781 | stats count",
        "latest_time": "$when.latest$",
        "app": utils.getCurrentApp(),
        "auto_cancel": 90,
        "preview": true,
      ...
      lowSeveritySearch = new SearchManager({
        ...
        "earliest_time": "$when.earliest$",
        "status_buckets": 0,
        "search": "index=" + selectedIndex + " " + nameFilter + " sourcetype=wazuh rule.alertsSeverityOverTime=\"audit\" rule.id=80791 | stats count",
        "latest_time": "$when.latest$",
        "app": utils.getCurrentApp(),
        "auto_cancel": 90,
        "preview": true,
      ...
      alertsSeverityOverTime = new SearchManager({
        ...
        "earliest_time": "$when.earliest$",
        "status_buckets": 0,
        "search": "index=" + selectedIndex + " " + nameFilter + " sourcetype=wazuh rule.alertsSeverityOverTime=\"audit\" | top rule.alertsSeverityOverTime",
        "latest_time": "$when.latest$",
        "app": utils.getCurrentApp(),
        "auto_cancel": 90,
        "preview": true,
      ...
      topAgentsSeverity = new SearchManager({
        ...
        "earliest_time": "$when.earliest$",
        "status_buckets": 0,
        "search": "index=" + selectedIndex + " " + nameFilter + " sourcetype=wazuh rule.alertsSeverityOverTime=\"audit\" agent.name=* | top agent.name",
        "latest_time": "$when.latest$",
        "app": utils.getCurrentApp(),
        "auto_cancel": 90,
        "preview": true,
      ...
      affectedPackages = new SearchManager({
        ...
        "earliest_time": "$when.earliest$",
        "status_buckets": 0,
        "search": "index=" + selectedIndex + " " + nameFilter + " sourcetype=wazuh rule.alertsSeverityOverTime=\"audit\" audit.directory.name=* | top audit.directory.name",
        "latest_time": "$when.latest$",
        "app": utils.getCurrentApp(),
        "auto_cancel": 90,
        "preview": true,
      ...
      alertsSummary = new SearchManager({
        ...
        "earliest_time": "$when.earliest$",
        "status_buckets": 0,
        "search": "index=" + selectedIndex + " " + nameFilter + " sourcetype=wazuh rule.alertsSeverityOverTime=\"audit\" audit.file.name=* | top audit.file.name",
        "latest_time": "$when.latest$",
        "app": utils.getCurrentApp(),
        "auto_cancel": 90,
        "preview": true,
