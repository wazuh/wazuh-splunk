...
/**
 * Anchor is a utility component to add a link to an element.
 */
...
function Anchor(_ref) {
  ...
  return external_react_default.a.createElement(StyledAnchor, _extends({
    "data-test": "anchor"
  }, Object(themes_["ref"])(elementRef), otherProps, {
    name: name,
    href: "#".concat(name)
  }), children);
}
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "default", function() { return Anchor_Anchor; });
