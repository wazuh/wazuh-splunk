...
var prism_empty = __webpack_require__(49);
...
// CONCATENATED MODULE: ./src/Code/CodeStyles.js


var Styled = external_styled_components_default.a.pre.withConfig({
  displayName: "CodeStyles__Styled",
  componentId: "sc-1p01a1i-0"
})(["", ";color:", ";line-height:17px;text-align:left;tab-size:4;white-space:pre;word-spacing:normal;word-break:normal;word-wrap:normal;hyphens:none;overflow-x:auto;margin-bottom:1.3em;"], Object(themes_["mixin"])('reset')('block'), Object(themes_["variable"])('Code', 'color'));
var StyledCode = external_styled_components_default.a.code.withConfig({
  displayName: "CodeStyles__StyledCode",
  componentId: "sc-1p01a1i-1"
})(["font-family:", ";"], Object(themes_["variable"])('monoFontFamily'));
var StyledIndent = external_styled_components_default.a.span.withConfig({
  displayName: "CodeStyles__StyledIndent",
  componentId: "sc-1p01a1i-2"
...
var StyledToken = external_styled_components_default.a.span.withConfig({
  ...
  componentId: "sc-1p01a1i-3"
})(["color:", ";cursor:", ";opacity:", ";font-style:", ";font-weight:", ";"], function (props) {
  return Object(themes_["variable"])('Code', "".concat(props.partType, "Token"));
}, function (props) {
  return props.partType === 'entity' ? 'help' : null;
}, function (props) {
  return props.partType === 'namespace' ? 0.7 : null;
}, function (props) {
  return props.partType === 'italic' ? 'italic' : null;
}, function (props) {
  return props.partType === 'important' || props.partType === 'bold' ? 'bold' : null;
});

// CONCATENATED MODULE: ./src/Code/Code.jsx
...
var supportedLanguages = ['bash', 'clike', 'css', 'html', 'javascript', 'js', 'markup', 'mathml', 'svg', 'xml'];
...
function Code(props) {
  var elementRef = props.elementRef,
      ...
      otherProps = _objectWithoutProperties(props, ["elementRef", "value", "indentChars", "language", "showIndentGuide"]);
  ...
  var makeIndentGuide = function makeIndentGuide(spaces) {
    ...
    var spans = Object(external_lodash_["times"])(level, function (idx) {
      return external_react_default.a.createElement(StyledIndent, {
        key: idx.toString()
      }, indentBlock);
    });
  ...
  var render = function render(tks) {
    return tks.map(function (part, idx) {
      if (typeof part === 'string') {
        ...
        return Object(external_lodash_["flatten"])(lines.map(function (line, lineNo) {
          ...
          if (!indentMatch) {
            ...
            res.push(external_react_default.a.createElement("span", {
      ...
      return external_react_default.a.createElement(StyledToken, {
        partType: part.type,
        key: idx.toString()
      }, content);
    });
  ...
  return external_react_default.a.createElement(Styled, _extends({
    "data-test": "code"
  }, Object(themes_["ref"])(elementRef), otherProps), external_react_default.a.createElement(StyledCode, {
    className: "language-".concat(language)
  }, codeContent));
}
Code.propTypes = propTypes;
Code.defaultProps = defaultProps;
// CONCATENATED MODULE: ./src/Code/index.js
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "default", function() { return Code; });
