...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var wrapClasses = (0, _classnames.default)(addPrefix('wrapper'), className, (_classNames = {}, _classNames[addPrefix("placement-" + _lodash.default.kebabCase((0, _utils.placementPolyfill)(placement)))] = placement, _classNames));
