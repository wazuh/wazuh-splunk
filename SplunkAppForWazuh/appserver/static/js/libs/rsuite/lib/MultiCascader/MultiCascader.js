...
function (_React$Component) {
  ...
  function MultiCascader(props) {
    ...
    _this.isControlled = !_lodash.default.isUndefined(_value);
  ...
  MultiCascader.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (isChangedData || isChangedValue) {
      ...
      var newChildren = (_lodash.default.get(nextSelectNode, childrenKey) || []).map(function (item) {
  ...
  _proto.renderDropdownMenu = function renderDropdownMenu() {
    ...
    var menuProps = _lodash.default.pick(this.props, Object.keys(_DropdownMenu.default.propTypes));
