...
function (_React$Component) {
  ...
  function InputNumber(props) {
    ...
    _this.handleOnChange = function (value, event) {
      ...
      var isUnControl = _lodash.default.isUndefined(_this.props.value);

      _this.handleValue(value, event, isUnControl);
    };

    _this.handleBlur = function (event) {
      var targetValue = Number.parseFloat(_lodash.default.get(event, 'target.value'));
    ...
    _this.handleWheel = function (event) {
      ...
      if (!disabled && event.target === document.activeElement) {
        ...
        var delta = _lodash.default.get(event, 'wheelDelta') || -event.deltaY || -_lodash.default.get(event, 'detail');
    ...
    var _getButtonStatus = getButtonStatus(_lodash.default.isUndefined(_value) ? defaultValue : _value, min, max),
  ...
  _proto.render = function render() {
    ...
    return React.createElement(_InputGroup.default, (0, _extends2.default)({}, rest, {
      ...
      onBlur: (0, _utils.createChainedFunction)(this.handleBlur, _lodash.default.get(htmlInputProps, 'onBlur')),
