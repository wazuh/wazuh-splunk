...
var ListContext = (0, _utils2.createContext)({
  bordered: false,
  size: 'md',
  manager: null
});
...
function (_React$Component) {
  ...
  function List() {
    ...
    _this.handleSortMove = function (event) {
      ...
      var translate = {
        x: _lodash.default.get(offset, 'x', 0) - _this.cursorInitialOffset.x,
        y: _lodash.default.get(offset, 'y', 0) - _this.cursorInitialOffset.y
    ...
    _this.handleSortEnd = function (event) {
      ...
      (0, _utils.setTranslate3d)(_this.activeNodeFlowBody, _this.holderTranslate);
      (0, _utils.setTransitionDuration)(_this.activeNodeFlowBody, transitionDuration); // wait for animation
  ...
  _proto.render = function render() {
    ...
    var _this$props4 = this.props,
        ...
        rest = (0, _objectWithoutPropertiesLoose2.default)(_this$props4, ["className", "classPrefix", "bordered", "hover", "size", "sortable", "children"]);
  ...
  (0, _createClass2.default)(List, [{
    ...
    get: function get() {
      ...
      this.animatedNodeOffset.forEach(function (_ref2, index) {
        ...
        var node = _lodash.default.get(nodeItem, 'node');
        ...
        if (!nodeItem.edgeOffset) {
          nodeItem.edgeOffset = (0, _utils.getEdgeOffset)(node, _this3.containerRef.current);
        }
