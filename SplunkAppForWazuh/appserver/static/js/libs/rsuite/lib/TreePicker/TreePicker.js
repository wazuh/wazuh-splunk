...
function (_React$Component) {
  ...
  function TreePicker(props) {
      ...
      var loop = function loop(nodes) {
        nodes.forEach(function (node) {
          ...
          if (!disabled) {
            ...
            if (!(0, _treeUtils.getExpandState)(node, _this.props)) {
              return;
            }
    ...
    _this.handleSearch = function (value, event) {
      ...
      if (_lodash.default.isUndefined(searchKeyword)) {
        _this.setState({
          searchKeyword: value,
  ...
  TreePicker.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (_lodash.default.isArray(data) && _lodash.default.isArray(prevState.data) && prevState.data !== data) {
      nextState.data = data;
    }
    ...
    if (!_lodash.default.isUndefined(searchKeyword) && searchKeyword !== prevState.searchKeyword) {
  ...
  _proto.updateSearchKeywordChange = function updateSearchKeywordChange(prevState) {
    ...
    if (!_lodash.default.isUndefined(this.props.searchKeyword) && prevState.searchKeyword !== this.props.searchKeyword) {
      this.setState({
  ...
  _proto.getValue = function getValue(props) {
    ...
    return !_lodash.default.isUndefined(value) ? value : defaultValue;
  };
  ...
  _proto.getActiveElementOption = function getActiveElementOption(options, value) {
    ...
    for (var i = 0; i < options.length; i += 1) {
      if (options[i].value === value) {
        ...
        if (!_lodash.default.isEmpty(active)) {
          return active;
        }
      }
    }
  ...
  _proto.getActiveItem = function getActiveItem() {
    ...
    if (activeItem !== null) {
      var _$get = _lodash.default.get(activeItem, 'dataset'),
          key = _$get.key,
          layer = _$get.layer;
  ...
  _proto.getFilterData = function getFilterData(data, word, props) {
    ...
    var setVisible = function setVisible(nodes) {
      ...
      return nodes.forEach(function (item) {
        ...
        if (_lodash.default.isArray(item[childrenKey])) {
    ...
    if (!_lodash.default.isUndefined(word)) {
      setVisible(data);
    }
  ...
  _proto.renderDropdownMenu = function renderDropdownMenu() {
    ...
    var keyword = !_lodash.default.isUndefined(searchKeyword) ? searchKeyword : this.state.searchKeyword;
  ...
  _proto.renderNode = function renderNode(node, index, layer) {
    ...
    var key = _lodash.default.isString(node[valueKey]) || _lodash.default.isNumber(node[valueKey]) ? node[valueKey] : refKey;
    var children = node[childrenKey]; // 当用户进行搜索时，hasChildren的判断要变成判断是否存在 visible 为 true 的子节点

    var visibleChildren = _lodash.default.isUndefined(searchKeyword) || searchKeyword.length === 0 ? !!children : (0, _treeUtils.hasVisibleChildren)(node, childrenKey);
    var props = {
      value: node[valueKey],
      label: node[labelKey],
      index: index,
  ...
  _proto.renderTree = function renderTree() {
    ...
    var treeHeight = _lodash.default.isUndefined(height) && virtualized ? defaultHeight : height;
