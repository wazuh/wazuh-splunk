...
function (_React$Component) {
  ...
  function TreeNode() {
    ...
    _this.renderIcon = function () {
      ...
      var classes = (0, _classnames.default)(_this.addPrefix('expand-icon'), 'icon', (_classNames = {}, _classNames[_this.addPrefix('expanded')] = !!expand, _classNames));
  ...
  _proto.render = function render() {
    ...
    var styles = {
      paddingLeft: layer * _constants.TREE_NODE_PADDING + _constants.TREE_NODE_ROOT_PADDING
    };
