  ...
  function DropdownMenu(props) {
    ...
    _this.createMenuItems = function (items, groupId) {
      ...
      var nextItems = items.map(function (item, index) {
        ...
        if (_lodash.default.isUndefined(label) && _lodash.default.isUndefined(item.groupTitle)) {
        ...
        if (group && _lodash.default.isArray(item.children)) {
        ...
        } else if (_lodash.default.isUndefined(value) && !_lodash.default.isArray(item.children)) {
        ...
        return React.createElement(DropdownMenuItem, {
          ...
          key: groupId + "-" + onlyKey,
          disabled: disabled,
          active: !_lodash.default.isUndefined(activeItemValues) && activeItemValues.some(function (v) {
            return (0, _utils.shallowEqual)(v, value);
          }),
          focus: !_lodash.default.isUndefined(focusItemValue) && (0, _utils.shallowEqual)(focusItemValue, value),
          value: value,
