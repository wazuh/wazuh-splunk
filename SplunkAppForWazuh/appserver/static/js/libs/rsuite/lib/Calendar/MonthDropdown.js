...
function (_React$PureComponent) {
  ...
  function MonthDropdown() {
    ...
    _this.getRowCount = function () {
      ...
      return (0, _dateFns.getYear)(new Date()) + limitEndYear;
    };
    ...
    _this.rowRenderer = function (_ref2) {
      ...
      var selectedYear = (0, _dateFns.getYear)(date);
      var year = index + 1;
  ...
  _proto.disabledMonth = function disabledMonth(year, month) {
    ...
    if (disabledMonth) {
      var days = (0, _dateFns.getDaysInMonth)(new Date(year, month)); // If all dates in a month are disabled, disable the current month
  ...
  _proto.render = function render() {
    ...
    return React.createElement("div", (0, _extends2.default)({}, unhandled, {
      ...
      return React.createElement(_List.default, {
        ...
        rowCount: count,
        scrollToIndex: (0, _dateFns.getYear)(date),
