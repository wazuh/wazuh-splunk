...
function (_React$Component) {
  ...
  _proto.isExpanded = function isExpanded() {
    return _lodash.default.isUndefined(this.props.expanded) ? this.state.expanded : this.props.expanded;
  };
  ...
  _proto.renderCollapsibleBody = function renderCollapsibleBody(panelRole) {
    ...
    var collapseProps = (0, _extends2.default)({}, _lodash.default.pick(this.props, _lodash.default.get(_Collapse.default, 'handledProps')), {
      in: this.isExpanded()
    });
    var props = {
      id: id ? "" + id : null,
  ...
  _proto.renderHeading = function renderHeading(headerRole) {
    ...
    if (!React.isValidElement(header) || Array.isArray(header)) {
      ...
      var className = (0, _classnames.default)(this.addPrefix('title'), _lodash.default.get(header, 'props.className'));
