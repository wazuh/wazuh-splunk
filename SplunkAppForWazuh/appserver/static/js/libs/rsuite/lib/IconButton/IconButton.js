...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var classes = (0, _classnames.default)(classPrefix, className, addPrefix("placement-" + placement), (_classNames = {}, _classNames[addPrefix('circle')] = circle, _classNames[addPrefix('with-text')] = !_lodash.default.isUndefined(children), _classNames));
