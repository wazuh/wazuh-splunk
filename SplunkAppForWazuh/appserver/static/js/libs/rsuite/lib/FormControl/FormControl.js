...
function (_React$Component) {
  ...
  function FormControl(_props, context) {
    ...
    _this.renderAccepter = function () {
      ...
      if (_lodash.default.get(Component, 'defaultProps.componentClass') === 'input' && readOnly) {
  ...
  _proto.getReadOnly = function getReadOnly() {
    ...
    if (!_lodash.default.isUndefined(readOnly)) {
      return readOnly;
    }
  ...
  _proto.getPlaintext = function getPlaintext() {
    ...
    if (!_lodash.default.isUndefined(plaintext)) {
      return plaintext;
    }
  ...
  _proto.render = function render() {
    ...
    if (plaintext && (_lodash.default.isUndefined(value) || _lodash.default.isNull(value))) {
