...
var defaultRanges = [{
  ...
  label: 'yesterday',
  value: [(0, _utils2.setTimingMargin)((0, _dateFns.addDays)(new Date(), -1)), (0, _utils2.setTimingMargin)((0, _dateFns.addDays)(new Date(), -1), 'right')]
}, {
  label: 'last7Days',
  value: [(0, _utils2.setTimingMargin)((0, _dateFns.subDays)(new Date(), 6)), (0, _utils2.setTimingMargin)(new Date(), 'right')]
}];
