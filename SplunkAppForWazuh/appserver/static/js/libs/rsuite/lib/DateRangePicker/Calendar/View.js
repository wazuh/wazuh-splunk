...
function (_React$Component) {
  ...
  function View() {
    ...
    _this.inSameThisMonthDate = function (date) {
      var thisMonthDate = (0, _dateFns.setDate)(_this.props.activeDate, 1);
      return (0, _dateFns.isSameMonth)(date, thisMonthDate);
    };
  ...
  _proto.render = function render() {
    ...
    var thisMonthDate = (0, _dateFns.setDate)(activeDate, 1);
