...
function (_React$Component) {
  ...
  function Calendar() {
    ...
    _this.handleMoveForword = function () {
      ...
      onMoveForword && onMoveForword((0, _dateFns.addMonths)(_this.getPageDate(), 1));
    };

    _this.handleMoveBackward = function () {
      var onMoveBackward = _this.props.onMoveBackward;
      onMoveBackward && onMoveBackward((0, _dateFns.addMonths)(_this.getPageDate(), -1));
    };
    ...
    _this.disabledBackward = function () {
      ...
      var after = (0, _dateFns.isAfter)(calendarDate[1], (0, _dateFns.addMonths)(calendarDate[0], 1));
    ...
    _this.disabledMonth = function (date) {
      ...
      if (index === 1) {
        after = (0, _dateFns.isAfter)(date, calendarDate[0]);
        return !after;
      }

      after = (0, _dateFns.isAfter)(calendarDate[1], date);
      return !after;
    };
