...
| :------------: | :---------------: | :--------------------------------------------------------------|
|      8.2.2     |       4.2.6       | <https://packages.wazuh.com/4.x/ui/splunk/wazuh_splunk-4.2.6_8.2.2-1.tar.gz>  |
|      8.1.4     |       4.2.6       | <https://packages.wazuh.com/4.x/ui/splunk/wazuh_splunk-4.2.6_8.1.4-1.tar.gz>  |
